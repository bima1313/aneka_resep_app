...
class SizeBiggest extends StatefulWidget {
  const SizeBiggest({Key? key}) : super(key: key);

  @override
  State<SizeBiggest> createState() => _SizeBiggestState();
}

class _SizeBiggestState extends State<SizeBiggest> {
  int _currentPage = 0;
  List<Widget> pages = const [
    FoodsBody(),
    DrinksBody(gridCount: 4),
  ];
  @override
